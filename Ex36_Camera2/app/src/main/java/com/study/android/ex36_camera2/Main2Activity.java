    ...
    Camera.PictureCallback myPictureCallback_JPG = new Camera.PictureCallback(){
        ...
        public void onPictureTaken(byte[] arg0, Camera arg1) {
            ...
            Uri uriTarget = getContentResolver().insert
                    ...
                    new ContentValues());
            OutputStream imageFilesOS;
            try {
                imageFilesOS = getContentResolver().openOutputStream(uriTarget);
                ((OutputStream) imageFilesOS).write(arg0);
                ((OutputStream) imageFilesOS).flush();
                ((OutputStream) imageFilesOS).close();
