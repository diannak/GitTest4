package com.study.android.ex_kakaoapi;
...
public class MainActivity extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapReverseGeoCoder.ReverseGeoCodingResultListener {
    ...
    private static final String LOG_TAG = "lecture";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.setItemName("경복궁");
        marker.setTag(0);
        marker.setMapPoint(MapPoint.mapPointWithGeoCoord(37.575936899999995, 126.9768157));
...
출처: https://liveonthekeyboard.tistory.com/entry/안드로이드-카카오-링크-API-사용법 [키위남]
*/