...
public class MainActivity extends AppCompatActivity {
    ...
    private void showNoPermissionToastAndFinish(){
        Toast.makeText(this, "권한 동의시 이용가능.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private File createImageFile() throws IOException {
        ...
        String timeStamp = new SimpleDateFormat("yyyymmddd_hhmmssss").format(new Date());
    ...
    private void getPictureFromCamera(){
        ...
        //이미지뷰에 비트맵 넣기
        imageView.setImageBitmap(rotate(bitmap,exifDegree)); //방향
